...
// Add creates a new Subnetwork Controller and adds it to the Manager. The Manager will set fields on the Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	c, err := controller.New("subnetwork-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}

	// Watch for changes to primary resource Subnetwork
	err = c.Watch(&source.Kind{Type: &computev1.Subnetwork{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner Subnetwork
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &computev1.Subnetwork{},
	})
	if err != nil {
		return err
	}
...
var _ reconcile.Reconciler = &ReconcileSubnetwork{}

// ReconcileSubnetwork reconciles a Subnetwork object
...
// and what is in the Subnetwork.Spec
